...
class ProductController extends Controller
{
    ...
    public function store(Request $request, Product $product)
    {
        $request->validate([
            ...
            'ingredients' => 'required| min:4 | max:500',
            'visibility' => 'boolean',
            ...
            'ingredients.min' => 'La lunghezza non può essere minore di :min caratteri',
            'ingredients.max' => 'La lunghezza non può essere maggiore di :max caratteri',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'name.max' => 'La lunghezza non può essere maggiore di :max caratteri',
            'name.min' => 'La lunghezza non può essere minore di :min caratteri',
            'ingredients.min' => 'La lunghezza della descrizione non può essere minore di :min caratteri',
            'ingredients.max' => 'La lunghezza della descrizione non può essere maggiore di :max caratteri',
            'price.numeric' => 'Il prezzo deve essere un numero',
            'price.min' => 'Il prezzo deve essere minimo :min euro',
            'price.max' => 'Il prezzo deve essere massimo :max euro',
            'price.required' => 'Il prezzo è obbligatorio',
