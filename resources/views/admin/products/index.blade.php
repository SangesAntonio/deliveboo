                    ...
                    <div class="d-flex flex-row justify-content-end align-items-center">
                        ...
                        <div class="ml-2">
                            <a href="{{ route('admin.products.trash.index') }}"
                                class="btn btn-small btn-danger text-white"><i class="fa-solid fa-trash"></i> Cestino</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="media product-details">
                                    ...
                                    <div class="media-body ml-3 text-left">
                                        ...
                                        <div class="d-flex justify-content-end pt-2">
                                            ...
                                            <div class="modal fade" id="ModalTrash{{ $product->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn info-cs w-25"
        ...
        <section id="stats-subtitle" class="pt-5">
            ...
            <div class="row">
                @foreach ($products as $product)
                    <a role="button" href="{{ route('admin.products.show', $product->id) }}"
