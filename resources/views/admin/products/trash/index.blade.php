      ...
      <div class="row">
        <div class="col-12 my-1">
          <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('admin.products.index') }}" class="d-flex align-items-center btn btn-sm btn-success text-white"><i
                class="fa-solid fa-chevron-left"></i><span class="ml-2">Torna ai prodotti</span></a>
            </a>
          </div>
        </div>
      </div>
                      ...
                      <div class="media-body text-right">
                        ...
                        <div class="d-flex justify-content-end pt-2">
                          ...
                          <form action="{{ route('admin.products.trash.restore', $product->id) }}" method="post">
                            @csrf
                            @method('patch')
                            <button type="submit" class="btn btn-sm btn-success">Ripristina</button>
                          </form>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form action="{{ route('admin.products.trash.destroy', $product->id) }}"
